package oibsip2.UserClasses;

import oibsip2.AdminClasses.HomeLibrary;
import oibsip2.BookClasses.*;
...
public class UserLoged extends JFrame {
     ...
     public UserLoged()
     {
          ...
          ImageIcon bgImg = new ImageIcon(ClassLoader.getSystemResource("oibsip2\\img\\VeryBlue.jpg"));
          ...
          ImageIcon Img12 = new ImageIcon(ClassLoader.getSystemResource("oibsip2\\img\\Img12.png"));
