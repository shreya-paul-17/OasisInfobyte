...
public class BooksForm extends JFrame {
    ...
    public BooksForm() {
        ...
        ImageIcon bgImg = new ImageIcon(ClassLoader.getSystemResource("oibsip2\\img\\JuicyOrange.jpg"));
        ...
        ImageIcon Img22 = new ImageIcon(ClassLoader.getSystemResource("oibsip2\\img\\Img22.jpg"));
